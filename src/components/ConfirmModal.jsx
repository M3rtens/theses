...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 modal-backdrop flex items-center justify-center p-8" onClick={onClose}>
      <div
      ...
      >
        ...
        <div className="p-6 border-t flex items-center justify-end gap-2" style={{ borderColor: 'var(--border)', background: 'var(--bg-warm)' }}>
